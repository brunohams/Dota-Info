            ...
            LazyColumn {
                item{
                    Column(
                        ...
                        HeroFilterSelector(
                            filterOnHero = {
                                onUpdateHeroFilter(HeroFilter.Alphabetic())
                            },
                            isEnabled = heroFilter is HeroFilter.Alphabetic,
                            order = if(heroFilter is HeroFilter.Alphabetic) heroFilter.order else null,
                            orderDesc = {
                                onUpdateHeroFilter(
                                    HeroFilter.Alphabetic(
...
/**
 * @param filterOnHero: Set the HeroFilter to 'Alphabetic'
 * @param isEnabled: Is the Alphabetic filter the selected 'HeroFilter'
...
fun HeroFilterSelector(
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = HeroFilter.Alphabetic().uiValue,
